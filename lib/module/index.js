...
const AndroidWallpaperModule = isTurboModuleEnabled ? require('./NativeAndroidWallpaper').default : NativeModules.AndroidWallpaper;
...
export function setWallpaper(imageUrl, whichScreen) {
  return AndroidWallpaper.setWallpaper(imageUrl, whichScreen);
}
export function getCropSetWallpaper(imageUrl, whichScreen) {
